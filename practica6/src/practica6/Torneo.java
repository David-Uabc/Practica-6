...
class Torneo{
    ...
    public Torneo(String nomTorneo, String region, int numEquipos, int parPendientes,int parJugados){
        ...
        System.out.println("Equipo "+ (i+1)+": "+equipos.get(i).getnomEquipo()+" - Puntos = "+equipos.get(i).puntosT()+" - Division = "+equipos.get(i).getDivisionEquipo());
